...
namespace Dcat\Admin {
     ...
     * @property Grid\Column|Collection card_tel
     ...
     * @method Grid\Column|Collection card_tel(string $label = null)
     ...
     * @property Show\Field|Collection card_tel
     ...
     * @method Show\Field|Collection card_tel(string $label = null)
