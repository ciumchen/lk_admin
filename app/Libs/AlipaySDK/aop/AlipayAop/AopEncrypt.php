...
class AopEncrypt
{
    ...
    public static function encrypt($str, $secret_key)
    {
        ...
        //设置全0的IV
        $iv = str_repeat("\0", 16);
        $encrypt_str = openssl_encrypt($str, 'aes-128-cbc', $secret_key, OPENSSL_NO_PADDING, $iv);
    ...
    public static function decrypt($str, $secret_key)
    {
        ...
        //设置全0的IV
        $iv = str_repeat("\0", 16);
        $decrypt_str = openssl_decrypt($str, 'aes-128-cbc', $secret_key, OPENSSL_NO_PADDING, $iv);
