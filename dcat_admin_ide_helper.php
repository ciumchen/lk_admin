...
namespace Dcat\Admin {
     ...
     * @property Grid\Column|Collection item_num
     * @property Grid\Column|Collection card_list
     * @property Grid\Column|Collection receive_mobile
     * @property Grid\Column|Collection receive_email
     * @property Grid\Column|Collection game_area
     * @property Grid\Column|Collection game_server
     * @property Grid\Column|Collection face_price
     * @property Grid\Column|Collection ext_pay
     ...
     * @method Grid\Column|Collection item_num(string $label = null)
     * @method Grid\Column|Collection card_list(string $label = null)
     * @method Grid\Column|Collection receive_mobile(string $label = null)
     * @method Grid\Column|Collection receive_email(string $label = null)
     * @method Grid\Column|Collection game_area(string $label = null)
     * @method Grid\Column|Collection game_server(string $label = null)
     * @method Grid\Column|Collection face_price(string $label = null)
     * @method Grid\Column|Collection ext_pay(string $label = null)
     ...
     * @property Show\Field|Collection item_num
     * @property Show\Field|Collection card_list
     * @property Show\Field|Collection receive_mobile
     * @property Show\Field|Collection receive_email
     * @property Show\Field|Collection game_area
     * @property Show\Field|Collection game_server
     * @property Show\Field|Collection face_price
     * @property Show\Field|Collection ext_pay
     ...
     * @method Show\Field|Collection item_num(string $label = null)
     * @method Show\Field|Collection card_list(string $label = null)
     * @method Show\Field|Collection receive_mobile(string $label = null)
     * @method Show\Field|Collection receive_email(string $label = null)
     * @method Show\Field|Collection game_area(string $label = null)
     * @method Show\Field|Collection game_server(string $label = null)
     * @method Show\Field|Collection face_price(string $label = null)
     * @method Show\Field|Collection ext_pay(string $label = null)
